    ...
    .then(value => {
        for (const usersItem of value) {
            ...
            btn.addEventListener('mousedown', function () {
                ...
                fetch(`https://jsonplaceholder.typicode.com/users/${usersItem.id}`)
                    .then(value => value.json())
                    .then(value => {
                        localStorage.clear()
...
//         for (const detailsItem of value) {
//             let details = document.createElement('div')
//             details.innerText = detailsItem.body;
//
//             detailsDiv.appendChild(details)
//         }
//
//                     userDetails.append(detailsDiv)
//                     usersId.append(button)
//                     usersDiv.append(usersId)
//                 })
//
//         }
