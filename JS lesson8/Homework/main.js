...
// document.getElementById('content').innerText='іва ва а ііаіва ds sdfd';

// -- замініть текст параграфа з id 'rules' на будь-який інший
// document.getElementById('rules').innerText='dslkfj lkjsdfklj lkjdsfljs lkdsfljlskjdfljslfjjf';
