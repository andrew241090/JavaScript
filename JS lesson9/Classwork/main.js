...
// for (const arr of simpsons){
//     let array = document.createElement('div');
//     array.classList.add('member');
//     array.innerText = `${arr.name} ${arr.surname} ${arr.age}`;
...
//     array.classList.add('member');
//
//     let arrName = document.createElement('div');
//     arrName.innerText= arr.name;
//     let arrSurname = document.createElement('div');
//     arrSurname.innerText = arr.surname;
//     let arrAge = document.createElement('div');
//     arrAge.innerText = arr.age;
//     let arrInfo = document.createElement('div');
//     arrInfo.innerText = arr.info;
//     let arrPhoto = document.createElement('div');
//     arrPhoto.innerText = arr.photo;
//     array.appendChild(arrName);
//     array.appendChild(arrSurname);
//     array.appendChild(arrAge);
//     array.appendChild(arrInfo);
//     array.appendChild(arrPhoto);
//     document.body.appendChild(array);
// }
...
for (const course of coursesArray) {
    ...
    duration.classList.add('durations');
    ...
    for (const moduleItem of course.modules) {
        ...
        modulesElement.style.width='100%';
        modulesElement.style.background='silver';
    }
    ...
    courseElement.appendChild(modblock);
    modblock.appendChild(modulesElement);
